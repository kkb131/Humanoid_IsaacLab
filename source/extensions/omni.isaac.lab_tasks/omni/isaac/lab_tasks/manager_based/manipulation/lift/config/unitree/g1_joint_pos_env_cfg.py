...
from omni.isaac.lab_tasks.manager_based.manipulation.lift.g1_lift_env_cfg import G1LiftEnvCfg
...
@configclass
class G1CubeLiftEnvCfg(G1LiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.robot.init_state.pos = [0.1, 0, 0.3]
