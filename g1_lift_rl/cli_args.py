...
def parse_rsl_rl_cfg(task_name: str, args_cli: argparse.Namespace) -> RslRlOnPolicyRunnerCfg:
    ...
    from omni.isaac.lab_tasks.manager_based.manipulation.lift.config.unitree.agents.rsl_rl_cfg import CabinetPPORunnerCfg

    # load the default configuration
    rslrl_cfg: RslRlOnPolicyRunnerCfg = CabinetPPORunnerCfg() #load_cfg_from_registry(task_name, "rsl_rl_cfg_entry_point")
